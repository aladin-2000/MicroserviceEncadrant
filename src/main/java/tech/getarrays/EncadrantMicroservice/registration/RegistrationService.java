package tech.getarrays.EncadrantMicroservice.registration;


import lombok.AllArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import tech.getarrays.EncadrantMicroservice.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = encadrantService.addEncadrant(
                new Encadrant(
        ...
        String link = "http://localhost:8060/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
    ...
    public String confirmToken(String token) {
        ...
        encadrantService.enableEncadrant(
                confirmationToken.getEncadrant().getEmail());
        return "confirmed";
    }
